...
">
  ...
  <div id="btninfos">
    <button class="btntally" onclick="window.location.href='{{route('Tally')}}' ">Tally</button>
    <button class="btnresult" onclick="window.location.href='{{route('allevents')}}' ">Results</button>
              ...
              <a href="javascript:void(0)" class="  mb-2" aria-current="true" style="cursor: default;background-color:transparent;text-decoration:none;color:white">
                ...
                <div class="d-flex w-100 justify-content-between">
                  ...
                  <small style="font-size:11px">
                    <span style="color: #dfdfdf"><time class="timeago" datetime="{{$ann->date_added}}" title="{{$ann->date_added}}"></time></span>
                  </small>
                </div>
