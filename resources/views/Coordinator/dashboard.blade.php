    ...
    <div class="row">
      ...
      <div class="col-md-4 mt-4">
        <div class="card shadow-sm " style="background-color: rgba(168, 146, 18, 0.877)">
          <div class="card-body">
            <h5 class="hf text-light">Event Coordinators</h5>
            <h6 class="af text-light" style="font-size:14px;" >
           <span class="badge bg-light text-dark" style="font-size:17px;z-index:9">{{count($coordinator)}}</span>  Accounts
            </h6>
            <i  class="dashboardbanner fas fa-link" style="z-index: 0"></i>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card-body">
             ...
             <script>
              ...
              var chart = new CanvasJS.Chart("chartContainer", {
                ...
                title:{
                  text: "All SPORTEVENTS AND ITS PARTICIPANTS"
                },
             /*    subtitles: [{
