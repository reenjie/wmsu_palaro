        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <input id="email" type="email" class="form-control af mb-2 @error('email') is-invalid @enderror"
                    ...
                    <input id="password" type="password" class="form-control af @error('password') is-invalid @enderror"
                    ...
                    <a href="/register" style="text-decoration: none;font-size:14px" class="btn btn-link af mt-2">Not yet
                        Registered?</a>
