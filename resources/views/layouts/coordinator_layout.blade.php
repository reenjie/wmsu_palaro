            ...
            <div class="userinfo">
                ...
                <div class="dropdown" style="font-weight: bolder;z-index: 9999">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="font-size: 13px;">
                        <li><a class="dropdown-item" href="{{ route('coordinator.profile') }}">Profile</a></li>
            ...
            <div class="navigations">
                ...
                <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="font-size: 14px">
                    ...
                    <li class="nav-item navitems">
                        <a class="nav-link navlinks " href="{{ route('coordinator.dashboard') }}">
                    ...
                    <li class="nav-item navitems">
                        <a class="nav-link navlinks  " href="{{ route('coordinator.announcement') }}">
                            <i class="fas fa-info-circle"></i>
                            <span>Announcement</span></a>
                    </li>

                    {{-- <li class="nav-item navitems">
                        <a class="nav-link navlinks  " href="{{route('coordinator.media')}}">
                    ...
                    <li class="nav-item navitems ">
                        <a class="nav-link navlinks " href="{{ route('coordinator.participants') }}">
                    ...
                    <li class="nav-item navitems">
                        <a class="nav-link navlinks  " href="{{ route('coordinator.students') }}">
                            <i class="fas fa-users"></i>
